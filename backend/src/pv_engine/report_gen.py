...
class ReportGenerator:
    ...
    def generate_csuite_briefing(
        ...
        # 6. Footer Disclaimer & Governance
        story.append(HRFlowable(width="100%", thickness=1, color=gray_border, spaceAfter=10))
        story.append(Paragraph(
            ...
            "Calculations strictly account for local temperature penalties, inverter DC/AC ratio clipping, and CBAM import tariff exposure.",
