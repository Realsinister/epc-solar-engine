...
PVModuleSchema = pa.DataFrameSchema({
    ...
    "module_power_Wp": pa.Column(float, pa.Check.in_range(50, 2000), coerce=True),
    "module_area_m2": pa.Column(float, pa.Check.in_range(0.5, 10.0), coerce=True),
    "GWP_total_A1A3_per_kWp_kgCO2e": pa.Column(float, pa.Check.in_range(50, 3000), coerce=True),
